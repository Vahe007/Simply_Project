...
export const getExhibitsPerPage = createAsyncThunk(
  "exhibits",
  async ({
    page = 1,
    sortBy = "",
    ...
    const response = await fetch(
      `${BASE_URL}exhibits?page=${page}&sortBy=${sortBy}&limit=${limit}&contains=${contains}&material=${material}&category=${category}&isActive=${isActive}`
    );
